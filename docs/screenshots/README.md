...
- `onboarding.png` — el modal que aparece la primera vez que se abre VS Code tras instalar la extensión (token + pasos).
...
El README usa URLs absolutas apuntando a GitHub raw, así funcionan tanto en el repo como en el Marketplace de VS Code.
